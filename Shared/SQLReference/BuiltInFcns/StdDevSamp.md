[Open topic with navigation](../../../index.html#Shared/SQLReference/BuiltInFcns/StdDevSamp.html)

[]()STDDEV\_SAMP
================

The <span class="CodeFont">STDDEV\_POP()</span> function returns the sample standard deviation of a set of numeric values.
